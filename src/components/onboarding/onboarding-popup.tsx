 ...
 *
 * 두 가지 이유로 플로우에서 뺐습니다.
 *   1. 금지 패턴 위반 — 적합도 `92%` 배지를 씁니다. 확률·점수는 어떤 형태로도
 *      쓰지 않습니다 (PR-2 · 디자인 시스템 2장).
 *   2. 콘텐츠가 옛 국제기구 프로젝트 것입니다 ("외교부 공공데이터", "UN 인턴십").
 *
 * 첫 방문자에게 서비스를 설명하는 일은 /intro/student가 맡습니다.
 * 다시 살리려면 카피와 미리보기를 4상태 표현으로 전부 새로 써야 합니다.
 */
